        ...
        <div style={{ display: 'grid', gap: '2rem', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))' }}>
          ...
          <Reveal delay={0}>
            <div className="surface-card" style={{
              height: '100%', padding: 'clamp(1.5rem, 4vw, 2.5rem)',
              ...
              <div>
                ...
                <div style={{ marginTop: '2.5rem', display: 'flex', alignItems: 'flex-end', gap: '0.5rem' }}>
                  <span style={{ fontSize: 'clamp(3.5rem, 9vw, 5rem)', lineHeight: 1, fontWeight: 500, letterSpacing: '-0.02em' }}>{feeCard.percentage}</span>
          ...
          {/* Included */}
          <Reveal delay={140}>
            <div className="surface-card" style={{ height: '100%', padding: 'clamp(1.5rem, 4vw, 2.5rem)' }}>
