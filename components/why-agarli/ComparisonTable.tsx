      ...
      <div className="container-editorial">
        ...
        <Reveal delay={140}>
          <div style={{ marginTop: '3rem' }}>
            <p className="md:hidden" style={{ fontSize: '0.75rem', color: '#9CA3AF', marginBottom: '0.625rem', textAlign: 'right' }}>
              Swipe horizontally to compare →
            </p>
            <div style={{ overflowX: 'auto', WebkitOverflowScrolling: 'touch', borderRadius: '1.5rem', border: '1px solid rgba(11,26,48,0.12)', background: '#fff' }}>
              <div style={{ minWidth: '540px' }}>
                {/* Header */}
                <div style={{
                  display: 'grid', gridTemplateColumns: '1.2fr 1fr 1fr',
                  gap: '1rem', borderBottom: '1px solid rgba(11,26,48,0.12)',
                  padding: '1.25rem clamp(1.25rem, 3vw, 2.5rem)', alignItems: 'center',
                }}>
                ...
                {rows.map(row => (
                  <div key={row.label} style={{
                    ...
                    padding: '1.25rem clamp(1.25rem, 3vw, 2.5rem)', alignItems: 'flex-start',
